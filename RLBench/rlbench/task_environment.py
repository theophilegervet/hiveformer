...
class TaskEnvironment(object):
    ...
    def step(self, action, collision_checking=False, compliant=False) -> Tuple[Observation, int, bool, List[Observation]]:
