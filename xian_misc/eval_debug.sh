...
use_instruction=0
offline=0
ckpt=/home/zhouxian/git/hiveformer/train_logs/05_02_singletask/insert_onto_square_peg-offset0-N3-T1000-V10000-symrot0-gptie1-simp1-B16-demo100-dim60-L2-lr1e-4-seed0-simpins0-ins_pos_emb0-vis_ins_att0-disc_rot0-5.0-10.0-rotcoef10-insinstructions_local.pkl_version167529/model.step=190000-value=0.00000.pth
