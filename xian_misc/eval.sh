...
python eval.py\
     --tasks $task\
     --checkpoint /home/zhouxian/git/hiveformer/train_logs/03_16_debugdebugdebug/pick_and_lift-offset0-N3-T1000-V10000-symrot0-gptie1-simp1-B16-lr1e-4_version158373/model.step=165000-value=0.00000.pth \
     --data_dir $valset\
